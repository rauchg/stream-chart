...
const LegendItem = ({
  ...
  return (
    <li
      className={cx(
        // base
        "group inline-flex flex-nowrap items-center gap-1.5 whitespace-nowrap rounded px-2 pr-0 py-1 transition",
        hasOnValueChange
        ...
        <ResponsiveContainer>
          <RechartsLineChart
            ...
            margin={{
              ...
              // modified from tremor, to fix the position of ReframeLegend
              top: 40,
            }}
          >
            {showGridLines ? (
            ...
            {showLegend ? (
              <RechartsLegend
                verticalAlign="top"
                /* modified from tremor, to fix positioning */
                align="right"
                /* modified from tremor, to fix positioning */
                wrapperStyle={{
                  marginTop: -40,
